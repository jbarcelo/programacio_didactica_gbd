...
Les primeres seccions són necessàriament genèriques i descriuen la programació en el seu conjunt.
No és fins a la secció \ref{sec:unitats} que tenim l'oportunitat de particularitzar per a cada una de les unitats didàctiques, concretant tots els aspectes que s'han descrit en les primeres seccions.

La secció \ref{sec:normativa} recull el marc normatiu en el qual es fonamenta aquesta programació.
Seguidament, a la secció \ref{sec:contextualització} descrivim el context en el qual s'impartirà aquesta assignatura.
...
Els objectius generals als quals contribueix el mòdul de gestió de bases de dades són: 4, 5 i 13.
...
\begin{itemize}
	...
	\item Administració de Sistemes Gestors de Bases Dades. Els SGBD (o DBMS en anglès) són els motors que permeten l'existència de les bases de dades. Una vegada conèixen els conceptes bàsics de bases de dades, és necessari aprendre el funcionament dels SGBD.
	\item Seguretat i Alta Disponibilitat. Les dades són un dels actius més importants de les organitzacions. S'han de prendre tota classe de mesures per a protegir aquestes dades i perquè estiguin en funcionament en tot moment.
...
La secció \ref{sec:continguts} detalla les activitats de cada una de les unitats didàctiques mentre que el calendari orientatiu es troba a l'appèndix \ref{app:schedule}.
...
A continuació es descriuen cada una de les dotze unitats didàctiques d'aquesta programació.
  ...
  Timing: 16 hours. Sept. 23th - Oct. 4th.
  ...
  \begin{itemize}
	  ...
	  \item 400 minutes. Assignment. Introduction to Databases.
  ...
  Timing: 20 hours. Oct. 7th - Oct. 22nd.
  ...
  \begin{itemize}
	  ...
	  \item Assignment 3-1 Create a Database. (\faGraduationCap Learning results and evaluation criteria) 3a, 3b, 3c, 3d.
	  \item Assignment 3-2 A Dockerized Database.
	  \item Assignment 3-3 School Database Script. (\faGraduationCap Learning results and evaluation criteria) 4a, 4b, 5a, 5b, 5d.
	  \item Assignment 3-4 Set Operators.
  ...
  \begin{itemize}
	  ...
	  \item Material 4-1 Queries MariaDB. (\faGraduationCap Learning results and evaluation criteria) 4f.
	  \item Material 4-2 Queries MariaDB. (\faGraduationCap Learning results and evaluation criteria) 4c, 4g, 5c.
  ...
  \begin{itemize}
	  ...
	  \item Material 5-1 Join. (\faGraduationCap Learning results and evaluation criteria) 4d, 4e.
	  \item Material 5-2 View.
	  \item Material 5-3 Transactions. (\faGraduationCap Learning results and evaluation criteria) 5f, 5g.
	  \item Material 5-4 Transactions.
	  \item Assignment 5-2 Two-phase locking and snapshop isolation. (\faGraduationCap Learning results and evaluation criteria) 5h.
  ...
  \begin{itemize}
	  ...
	  \item Assignment 6-1 Mini League. (\faGraduationCap Learning results and evaluation criteria) 5f, 5g
  ...
  \begin{itemize}
	  ...
	  \item Material 8-2 PostgreSQL PL/pgSQL. (\faGraduationCap Learning results and evaluation criteria) 5e.
  ...
  \begin{itemize}
	  ...
	  \item Material 9-2 E-R Exercises.
	  \item Assignment 9-1 Create an ERD. (\faGraduationCap Learning results and evaluation criteria) 2a, 2b.
  ...
  \begin{itemize}
	  \item Slides 10-1
	  \item Material 10-1 E-R to relational exercises.
	  \item Assignment 10-1 ERM to Relational Model. (\faGraduationCap Learning results and evaluation criteria) 2c, 2d, 2e, 2f, 2g, 2i, 3e, 3f, 3g, 3h, 3i.
  ...
  \begin{itemize}
	  ...
	  \item Assignment 11-1 Normalization. (\faGraduationCap Learning results and evaluation criteria) 2h.
  ...
  \subsubsection{Material.}
  \begin{itemize}
	  \item Assignment 12-1 Advanced Topics. (\faGraduationCap Learning results and evaluation criteria 6a, 6b, 6c, 6d, 6e, 6f, 6g, 6h).
...
Les característiques més significatives són l'ensenyament-aprenentatge en anglès i dual, on els estudiants passen part del temps a l'empresa.

Els continguts del marc normatiu s'han ajustat a la programació i s'han proposat procediments d'avaluació per als criteris d'avaluació del títol.
...
Es proposaran activitats o reptes als estudiants que cobriran els diferents continguts del mòdul.
...
En la formació professional, és adequat assignar tasques als alumnes que s'aproximen a les que es podrà trobar en el centre de treball.
...
Es pot anar ajustant depenent dels alumnats, els coneixements previs que disposen o el seu interès per les diferents temàtiques.
S'ha decidit tractar primer les unitats didàctiques relacionades amb SQL i posteriorment aquelles que estan relacionades amb el disseny de les bases de dades.
El motiu és que les tasques que es trobaran en incorporar-se al centre de treball probablement estaran relacionades amb queries sobre una base de dades existent més que no en el disseny de noves bases de dades, que habitualment són tasques reservades als analistes o personal amb més experiència.
...
El segon, plantejant activitats parcialment obertes on cadascú pugui explorar aspectes diferents en funció dels seus interessos o situació personal.
...
Els continguts del mòdul s'han organitzat en 12 unitats didàctiques.
...
Per tant, en el nostre curs no veurem tot allò que és al llibre.
