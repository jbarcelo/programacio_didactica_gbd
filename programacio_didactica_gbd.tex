...
A continuació es descriuen cada una de les dotze unitats didàctiques d'aquesta programació.
  ...
  \begin{itemize}
	  ...
	  \item 150 minutes. Assignment 2-2 Keys. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 2f
	  \item 150 minutes. Assignment 2-3 Relational Diagram. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 2b, 2c, 2d
  ...
  \begin{itemize}
	  ...
	  \item 150 minutes. Assignment 3-1 Create a Database. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 3a, 3b, 3c, 3d.
	  \item 150 minutes. Assignment 3-2 A Dockerized Database. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 6a, 6b, 6c, 6d, 6e.
	  \item 150 minutes. Assignment 3-3 School Database Script. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 4a, 4b, 5a, 5b, 6a, 6b, 6d, 6e.
  ...
  \begin{itemize}
	  ...
	  \item 200 minutes. Material 4-1 Queries MariaDB. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 4f.
	  \item 200 minutes. Material 4-2 Queries MariaDB. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 4c, 4g, 5c.
  ...
  \begin{itemize}
	  ...
	  \item 100 minutes. Material 5-1 Join. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 4d, 4e.
	  \item 100 minutes. Material 5-2 View.
	  \item 100 minutes. Material 5-3 Transactions 1. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 5f, 5g.
	  \item 100 minutes. Material 5-4 Transactions 2. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 6g.
	  \item 100 minutes. Assignment 5-2 Two-phase locking and snapshop isolation. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 5h.
	  \item 100 minutes. Review.
  ...
  \begin{itemize}
	  ...
	  \item 100 minutes. Assignment 6-1 Integrity Constraints.(\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 2g, 5d. 
  ...
  \begin{itemize}
	  ...
	  \item 300 minutes. Material 8-2 PostgreSQL PL/pgSQL. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 5e.
  ...
  \begin{itemize}
	  ...
	  \item 500 minutes. Assignment 9-1 Create an ERD. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 2a, 2b.
  ...
  \begin{itemize}
	  ...
	  \item 600 minutes. Assignment 10-1 ERM to Relational Model. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 2c, 2d, 2e, 2f, 2g, 2i, 3e, 3f, 3g, 3h, 3i.
  ...
  \begin{itemize}
	  ...
	  \item 300 minutes. Assignment 11-1 Normalization. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació) 2h.
  ...
  \begin{itemize}
          \item We allow the first five minutes and the last five minutes of each 110 minutes session for setting up the computers and shutting them down. Also for doubts, questions, feedback and keeping a class diary.
	  \item 600 minutes. Assignment 12-1 Advanced Topics. (\faGraduationCap Resultats d'aprenentatge i criteris d'avaluació).
