...
A continuació es descriuen cada una de les dotze unitats didàctiques d'aquesta programació.
	...
	\item Learning outcomes: 
		\begin{itemize}
			\item 1. Recognizes the elements of databases analyzing their functions and assessing the usefulness of management systems.
				\begin{itemize}
					\item 1a) The different logical storage systems and their functions have been analyzed.
					\item 1b) The different types of databases have been identified according to the data model used.
					\item 1c) The different types of databases have been identified based on the location of the information.
					\item 1d) The usefulness of a database management system has been recognized.
					\item 1e) The function of each of the elements of a database management system has been described.
					\item 1f) Database management systems have been classified.
				\end{itemize}
		\end{itemize}
  \end{itemize}
	...
	\item Learning outcomes: 
		\begin{itemize}
			\item 2. Design normalized logical models interpreting entity/relationship diagrams.
				\begin{itemize}
					\item 2b) Graphic tools have been used to represent the logical design.
					\item 2c) The logical design tables have been identified.
					\item 2d) The fields that are part of the logical design tables have been identified.
					\item 2f) The key fields have been defined.
				\end{itemize}
		\end{itemize}
  \end{itemize}
	...
	\item Learning outcomes: 
		\begin{itemize}
			\item 3. Performs the physical design of databases using wizards, graphical tools and the data definition language.
				\begin{itemize}
					\item 3a) The physical storage structures have been defined.
					\item 3b) Tables have been created.
					\item 3c) The appropriate data types have been selected.
					\item 3d) The key fields in the tables have been defined.
				\end{itemize}
			\item 4. Consult the stored information using assistants, graphic tools and the data manipulation language.
				\begin{itemize}
					\item 4a) The tools and sentences to carry out queries have been identified.
					\item 4b) Simple queries have been made on a table.
				\end{itemize}
			\item 5. Modifies stored information using wizards, graphical tools, and the data manipulation language.
				\begin{itemize}
					\item 5a) The tools and statements to modify the content of the database have been identified.
					\item 5b) Data has been inserted, deleted and updated in the tables.
				\end{itemize}
			\item 6. Performs information assurance tasks, analyzing them and applying safeguard and transfer mechanisms.
				\begin{itemize}
					\item 6a) Graphical and command-line tools for managing backups have been identified.
					\item 6b) Backups have been made.
					\item 6c) Backups have been restored.
					\item 6d) Tools for importing and exporting data have been identified.
					\item 6e) Data has been exported to various formats.
				\end{itemize}
		\end{itemize}
  \end{itemize}
  ...
  \begin{itemize}
	...
	\item Learning outcomes: 
		\begin{itemize}
			\item 4. Consult the stored information using assistants, graphic tools and the data manipulation language.
				\begin{itemize}
					\item 4c) Queries have been made that generate summary values.
					\item 4f) Queries with subqueries have been made.
					\item 4g) The advantages and disadvantages of the different valid options to carry out a specific query have been assessed.
				\end{itemize}
			\item 5. Modifies stored information using wizards, graphical tools, and the data manipulation language.
				\begin{itemize}
					\item 5c) The information resulting from the execution of a query has been included in a table.
				\end{itemize}
		\end{itemize}
  \end{itemize}
  ...
  \begin{itemize}
	...
	\item Learning outcomes: 
		\begin{itemize}
			\item 4. Consult the stored information using assistants, graphic tools and the data manipulation language.
				\begin{itemize}
					\item 4d) The contents of several tables have been queried using inner joins.
					\item 4e) The contents of several tables have been queried using outer joins.
				\end{itemize}
			\item 5. Modifies stored information using wizards, graphical tools, and the data manipulation language.
				\begin{itemize}
					\item 5f) The functioning of the transactions has been recognized.
					\item 5g) The changes produced by a transaction have been partially or totally cancelled.
					\item 5h) The effects of the different record blocking policies have been identified.
				\end{itemize}
			\item 6. Performs information assurance tasks, analyzing them and applying safeguard and transfer mechanisms.
				\begin{itemize}
					\item 6g) The information provided by the error messages and the log files has been correctly interpreted.
				\end{itemize}
		\end{itemize}
  \end{itemize}
  ...
  \begin{itemize}
	  ...
	  \item 100 minutes. Material 5-4 Transactions 2. (\faGraduationCap Learning outcomes and evaluation criteria) 6g.
  ...
  \begin{itemize}
	...
	\item Learning outcomes: 
		\begin{itemize}
			\item 2. Design normalized logical models interpreting entity/relationship diagrams.
				\begin{itemize}
					\item 2g) Integrity rules have been applied.
				\end{itemize}
		\end{itemize}
  \end{itemize}
  ...
  \begin{itemize}
	  ...
	  \item 100 minutes. Assignment 6-1 Integrity Constraints. 
  ...
  \begin{itemize}
	...
	\item Learning outcomes: 
		\begin{itemize}
			\item 5. Modifies stored information using wizards, graphical tools, and the data manipulation language.
				\begin{itemize}
					\item 5e) Scripts have been designed to carry out complex tasks.
				\end{itemize}
		\end{itemize}
  \end{itemize}
  ...
  \begin{itemize}
	...
	\item Learning outcomes: 
		\begin{itemize}
			\item 2. Design normalized logical models interpreting entity/relationship diagrams.
				\begin{itemize}
					\item 2a) The meaning of the symbology of the entity/relationship diagrams has been identified.
					\item 2b) Graphic tools have been used to represent the logical design.
				\end{itemize}
		\end{itemize}
  \end{itemize}
  ...
  \begin{itemize}
	  ...
	  \item 150 minutes. Material 9-1 E-R Diagram Tool.
	  \item 250 minutes. Material 9-2 E-R Exercises.
  ...
  Note: It is likely that the time allocated to each activity is halved due to the fact that the students work part-time in an company.
		...
		\begin{itemize}
			\item 2. Design normalized logical models interpreting entity/relationship diagrams.
				\begin{itemize}
					\item 2c) The logical design tables have been identified.
					\item 2d) The fields that are part of the logical design tables have been identified.
					\item 2e) The relationships between the tables of the logical design have been identified.
					\item 2f) The key fields have been defined.
					\item 2g) Integrity rules have been applied.
					\item 2i) Constraints that cannot be captured in the logical design have been identified and documented.
				\end{itemize}
			\item 3. Performs the physical design of databases using wizards, graphical tools and the data definition language.
				\begin{itemize}
					\item 3e) All the restrictions reflected in the logical design have been implemented.
					\item 3f) It has been verified by means of a set of test data that the implementation conforms to the model.
					\item 3g) Wizards and graphic tools have been used.
					\item 3h) The data definition language has been used.
					\item 3i) The data dictionary has been defined and documented.
				\end{itemize}
		\end{itemize}
  \end{itemize}
  ...
  \begin{itemize}
	...
	\item Learning outcomes: 
		\begin{itemize}
			\item 2. Design normalized logical models interpreting entity/relationship diagrams.
				\begin{itemize}
					\item 2h) Normalization rules have been applied to an appropriate level.
				\end{itemize}
		\end{itemize}
  \end{itemize}
  ...
  \begin{itemize}
	  ...
	  \item Slides 11-2.
	  \item 300 minutes. Material 11-1 Exercises.
	  ...
	  \item 200 minutes. Assignment 11-3 Normalization Script.
  \end{itemize}
		...
		\begin{itemize}
			\item 6. Performs information assurance tasks, analyzing them and applying safeguard and transfer mechanisms.
				\begin{itemize}
					...
					\item 6d) Tools for importing and exporting data have been identified.
					\item 6e) Data has been exported to various formats.
					\item 6f) Data with different formats have been imported.
					\item 6g) The information provided by the error messages and the log files has been correctly interpreted.
					\item 6h) Information has been transferred between management systems.
				\end{itemize}
		\end{itemize}
  \end{itemize}
