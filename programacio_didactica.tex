...
TBD.
  ...
  \begin{itemize}
	  \item Assignment 1-1 Introduction to Databases \url{http://bit.ly/2UQj8Vt}
  ...
  \begin{itemize}
	  \item Practice 4-1 Queries MariaDB
	  \item Practice 4-2 Queries MariaDB
  ...
  \begin{itemize}
	  ...
	  \item Practice 5-1 Join 
	  \item Practice 5-2 View
	  \item Practice 5-3 Transactions
	  \item Practice 5-4 Transactions
  ...
  \subsubsection{Material}
  \begin{itemize}
	  \item Practice 6-1 Referential integrity and data types
	  \item Assignment 6-1 Mini League
	  \item Practice 6-2 Index Importance
	  \item Practice 6-3 Authorization
	  \item Practice 6-4 Roles
	  \item Practice 6-5 Dates
	  \item Database for Test 6
  ...
  \subsubsection{Material}
  \begin{itemize}
	  \item Practice 7-1 SQL statements in a java application
